...
install_dependencies() {
    ...
    sudo apt update
    sudo apt install -y lsb-release curl mysql-client openssl iptables curl wget sudo nano zip ufw apache2 mariadb-server php-fpm php-mysql php-curl php-dom php-json php-zip php-gd php-xml php-mbstring php-intl php-opcache
